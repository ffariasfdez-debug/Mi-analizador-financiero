...
ticker = st.sidebar.text_input("Introduce el Ticker:", "NVDA").upper()
    ...
    with st.spinner('Analizando mercado...'):
        ...
        if not df.empty:
            ...
            if precio_act > sma50_act:
                if rsi_act > 70:
                    st.warning("🟡 MANTENER: Tendencia alcista pero con euforia. No compres más.")
                else:
            ...
            st.error("No se encontraron datos. Revisa el Ticker.")a ese Ticker. Revisa si está bien escrito.")
